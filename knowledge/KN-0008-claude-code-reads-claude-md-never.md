...
evidence:
  ...
  - { type: diff, ref: "install.mjs step 5: Claude wiring, verified against npx skills add -a claude-code layout in /tmp/kg-demo" }
...
`kg-init` (install.mjs step 5) wires both surfaces: `.claude/skills/kg-*`
